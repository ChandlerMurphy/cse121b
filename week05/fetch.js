...
//   if (response.ok) {
//     // the API will send us JSON...but we have to convert the response before we can use it, .json() also returns a promise...so we await it as well.
...
function compare(a,b) {
    if (a.name > b.name) {
        ...
        // a and b different but unchanged (already in correct order)
        return -1;
